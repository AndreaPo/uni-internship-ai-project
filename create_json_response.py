...
#fun to extract the json response
def extract_json(my_response_txt, index):
    regex =r'(\{.*\})'
    ...
    if match_result:
            ...
            st.session_state['response_values'][index] = [correct_json_response["traccia"],correct_json_response["ragionamento"], correct_json_response["formula"],correct_json_response["soluzione"]]
